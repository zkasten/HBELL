...
class MyWidget(QWidget):
    def __init__(self, filename):
        ...
        self.pixmap = QPixmap("background2.png")
...
#        self.layout_numbers_s = QVBoxLayout()
        ...
        self.layout_numline1_2 = QHBoxLayout()
        self.layout_numline1_2.setSpacing(50)
...
#        self.layout_numline1_2_2 = QHBoxLayout()
        ...
        self.layout_numline2_2 = QHBoxLayout()
        self.layout_numline2_2.setSpacing(50)
...
#        self.layout_numline2_2_2 = QHBoxLayout()
        ...
        self.layout_numline1_2.addWidget(self.numLabel1_4, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline1_2.addWidget(self.numLabel1_5, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline1_2.addWidget(self.numLabel1_6, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline1_2.addWidget(self.numLabel1_7, alignment=Qt.AlignmentFlag.AlignHCenter)

        self.layout_numline2_2.addWidget(self.numLabel2_4, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline2_2.addWidget(self.numLabel2_5, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline2_2.addWidget(self.numLabel2_6, alignment=Qt.AlignmentFlag.AlignHCenter)
        self.layout_numline2_2.addWidget(self.numLabel2_7, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        self.layout_numbers_b.addLayout(self.layout_numline1_2)

        self.layout_numbers_b.addLayout(self.layout_numline2_1)
        self.layout_numbers_b.addLayout(self.layout_numline2_2)
