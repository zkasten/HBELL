...
# 2025-10-15 : CHG bellSender.py -> wifi_UDP_Sender.py - hyukjoo
        ...
        while True:
            ...
            with conn:
                while True:
                    ...
                    result = send_message(arr[0] , is_negative)  # "+" 형식으로 전송
